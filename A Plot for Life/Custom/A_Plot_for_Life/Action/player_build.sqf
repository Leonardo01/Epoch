...
if((count (([player] call FNC_GetPos) nearObjects ["All",DZE_checkNearbyRadius])) >= DZE_BuildingLimit) exitWith {DZE_ActionInProgress = false; cutText [(localize "str_epoch_player_41"), "PLAIN DOWN"];};
